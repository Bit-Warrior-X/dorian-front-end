        ...
        <div v-if="activeTab === 'general' && loadedSite" class="cfg-overview">
          ...
          <div class="cfg-metrics">
            ...
            <article class="cfg-metric cfg-metric--ok">
              ...
              <span class="cfg-metric__hint">{{ cacheHitMetricHint }}</span>
            </article>
...
const cacheHitMetricHint = computed(() => {
  const site = loadedSite.value
  if (!site) return 'Latest L7 cache sample'
...
const formatCacheRatio = (value) => {
  ...
  // Athens / live metrics use 0–1; legacy site forms may store 0–100.
