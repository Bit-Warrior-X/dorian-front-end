  ...
  <div class="waf-section-card">
    ...
    <div class="waf-table-wrapper">
      <table class="waf-table">
        ...
        <tbody>
          <tr v-for="rule in userAgentRules" :key="rule.id">
            <td class="checkbox-col">
              <input
                ...
                aria-label="Select user agent rule"
              />
            </td>
            <td>{{ rule.url }}</td>
            ...
            <td class="action-cell">
              ...
              <button
                ...
                @click="deleteUserAgentRule(rule)"
              >
                <svg viewBox="0 0 20 20" aria-hidden="true">
                  <path
          ...
          <tr v-if="!userAgentRules.length">
            <td colspan="7" class="empty-cell">No user agent rules yet.</td>
          </tr>
        </tbody>
      </table>
    </div>
    <div v-if="isDialogOpen" class="dialog-overlay" @click.self="closeDialog">
      <div class="dialog-card" role="dialog" aria-modal="true" aria-label="Add user agent rule">
        <div class="dialog-header">
          <h4>Add User Agent Rule</h4>
        ...
        <div class="dialog-body">
          ...
          <div class="form-field">
            <label for="ua-agent">
              User Agent <span class="required">*</span>
            </label>
            <div class="field-control">
              <input
                id="ua-agent"
                ...
                @blur="touched.agent = true"
              />
              <p v-if="showAgentRequired" class="field-error">This field is required</p>
            </div>
          </div>
          <div class="form-field">
            <label>
            ...
            <div class="field-control">
              <div class="option-group">
                <button
                  type="button"
                  class="option-btn"
                  :class="{ active: formState.match === 'Equals' }"
                  @click="formState.match = 'Equals'"
                >
                  Equals
                </button>
                <button
                  type="button"
                  class="option-btn"
                  :class="{ active: formState.match === 'Contains' }"
                  @click="formState.match = 'Contains'"
                >
                  Contains
                </button>
                <button
                  type="button"
                  class="option-btn"
                  :class="{ active: formState.match === 'Regex' }"
                  @click="formState.match = 'Regex'"
                >
                  Regex
                </button>
              </div>
    ...
    <div v-if="deleteTarget" class="dialog-overlay" @click.self="closeDeleteDialog">
      <div class="dialog-card dialog-confirm" role="dialog" aria-modal="true" aria-label="Delete user agent rule">
        <div class="dialog-header">
          <h4>Delete Rule</h4>
        ...
        <div class="dialog-body">
          <p class="confirm-text">
            Are you sure you want to delete this user agent rule?
          </p>
        </div>
        <div class="dialog-footer">
    ...
    <div v-if="isBatchConfirmOpen" class="dialog-overlay" @click.self="closeBatchConfirm">
      <div class="dialog-card dialog-confirm" role="dialog" aria-modal="true" aria-label="Batch delete user agent rules">
        <div class="dialog-header">
          <h4>Batch Removal</h4>
        ...
        <div class="dialog-body">
          <p class="confirm-text">
            Are you sure you want to delete the selected user agent rules?
          </p>
        </div>
        <div class="dialog-footer">
...
const deleteUserAgentRule = (rule) => {
